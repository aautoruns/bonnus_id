    ...
    <section class="pt-20">
        ...
        <body>
            ...
            <section class="pt-20">
                ...
                <!-- Hero -->
                <section class="pt-52 pb-36 pattern">
                    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                        <a href="#"
                            class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700"
                            role="alert">
                            <span class="text-xs bg-primary rounded-full text-white px-4 py-1.5 mr-3">Lorem</span> <span
                                class="text-sm font-medium">Lorem ipsum dolor sit amet consectetur.</span>
                        ...
                        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Lorem
                            ipsum dolor sit amet consectetur adipisicing elit. Cupiditate quia id laboriosam dolores eum iusto
                            saepe
                            nulla omnis asperiores officia.</p>
                        <div
                ...
                <section class="pt-32 pb-32">
                    <div class="container capitalize text-justify">
                        <h1 class="text-center text-4xl">Yuk kenali berbagai macam pulau di Indonesia</h1>
                        <p class="text-center text-base my-2">Indonesia adalah negara kepulauan terbesar di dunia yang luas
                            wilayahnya terdiri dari 2/3 wilayah lautan. diperkuat
                            dengan fakta lain bahwa Indonesia adalah pemilik garis pantai terpanjang kedua di dunia dengan 108
                            ribu kilometer.</p>
                        <div class="flex flex-wrap justify-center items-center my-10">
                            <a href="#"
                                class="flex flex-col items-center m-5 bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
                                    src="./img/assets/pulau/pulau_sumatera.png" alt="">
                                <div class="flex flex-col justify-between mx-5 p-4 leading-normal">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Pulau
                                        Sumatera
                                    </h5>
                                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Terkenal dengan ragam
                                        kebudayaannya, seperti Tarian Saman Aceh, Rumah Gadang Sumatera Barat, Lancang Kuning
                                        Riau,dan
                            ...
                            <a href="#"
                                class="flex flex-col items-center m-5 bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
                                    src="./img/assets/pulau/pulau_jawa.png" alt="">
                                <div class="flex flex-col justify-between mx-5 p-4 leading-normal">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Pulau Jawa
                                    </h5>
                                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Keragaman budaya suku Jawa
                                        antaranya adalah wayang kulit, keris, batik, kebaya, gamelan, tari-tarian, aksara Jawa,
                                        dan
                                        bahasa Jawa.
                                    </p>
                                </div>
                            ...
                            <a href="#"
                                class="flex flex-col items-center m-5 bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
                                    src="./img/assets/pulau/pulau_balidannusa.png" alt="">
                                <div class="flex flex-col justify-between mx-5 p-4 leading-normal">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Pulau Bali
                                        dan
                                        Nusa</h5>
                                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Suku-suku di Pulau Bali dan
                                        Nusa Tenggara ada beragam, mulai dari suku Bali, suku Nyama Selam, hingga suku Bayan.
                                    </p>
                                </div>
                            </a>
                            <a href="#"
                                class="flex flex-col items-center m-5 bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
                                    src="./img/assets/pulau/pulau_kalimantan.png" alt="">
                                <div class="flex flex-col justify-between mx-5 p-4 leading-normal">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Pulau
                                        Kalimantan</h5>
                                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">mengenal Keberagaman Suku di
                                        Indonesia yang ada di Pulau Kalimantan antara lain Suku Dayak, Suku Hakka, Suku Banjar
                                        dan
                                        Suku Melayu.
                                    </p>
                                </div>
                            ...
                            <a href="#"
                                class="flex flex-col items-center m-5 bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
                                    src="./img/assets/pulau/pulau_sulawesi.png" alt="">
                                <div class="flex flex-col justify-between mx-5 p-4 leading-normal">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Pulau
                                        Sulawesi
                                    </h5>
                                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">terkenal dengan adat dan budaya
                                        Toraja. Rumah adat di Sulsel berasal dari ketiga daerah (Makassar, Bugis dan Toraja).
                                    </p>
                                </div>
                            </a>
                            <a href="#"
                                class="flex flex-col items-center m-5 bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
                                    src="./img/assets/pulau/pulau_papua.png" alt="">
                                <div class="flex flex-col justify-between mx-5 p-4 leading-normal">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Pulau
                                        Maluku
                                        dan Papua</h5>
                                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Keberagaman Suku yang Ada di
                                        Papua dan Maluku adalah Suku Dani, Suku Amungme, Suku Asmat, Suku Ambon, Suku Tidore,
                                        dan
                                        Suku Tobelo.
                                    </p>
                                </div>
