    ...
    <section class="pt-20">
        ...
        <section id=portfolio class="pt-32 pb-32">
            <div class="container capitalize">
                <h1 class="text-4xl font-semibold">Pulau Jawa</h1>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        <a href="/banten.html">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/jawa_banten.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="/jakarta.html">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/jawa_dki.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="/jawa_barat.html">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/jawa_jabar.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="/jawa_tengah.html">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/jawa_jateng.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="/diy_yogyakarta.html">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/jawa_diy.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="/jawa_timur.html">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/jawa_jatim.png"
                                alt=""></a>
                    </div>
                </div>
            </div>
