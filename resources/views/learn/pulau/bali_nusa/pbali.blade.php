    ...
    <section class="pt-20">
        ...
        <section id=portfolio class="pt-32 pb-32">
            <div class="container capitalize">
                <h1 class="text-4xl font-semibold">Pulau Bali</h1>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/bali.png" alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/ntt.png" alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/ntb.png" alt=""></a>
                    </div>
                </div>
            </div>
        </section>
