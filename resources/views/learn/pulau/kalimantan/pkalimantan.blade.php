    ...
    <section class="pt-20">
        ...
        <section id=portfolio class="pt-32 pb-32">
            <div class="container capitalize">
                <h1 class="text-4xl font-semibold">Pulau Kalimantan</h1>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/kalimantan_timur.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/kalimantan_selatan.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/kalimantan_tengah.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/kalimantan_utara.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/kalimantan_barat.png"
                                alt=""></a>
                    </div>
                </div>
            </div>
