    ...
    <section class="pt-20">
        ...
        <section id=portfolio class="pt-32 pb-32">
            <div class="container capitalize">
                <h1 class="text-4xl font-semibold">Pulau Maluku dan Papua</h1>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/maluku_utara.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/maluku.png" alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/papua.png" alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/papua_barat.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/papua_selatan.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/papua_tengah.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/papua_pegunungan.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/papua_barat_daya.png"
                                alt=""></a>
                    </div>
                </div>
            </div>
