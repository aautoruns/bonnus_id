...
<body>
    ...
    <section class="pt-20">
        ...
        <!-- CTA -->
        <section id=portfolio class="pt-32 pb-32">
            <div class="container capitalize">
                <h1 class="text-4xl font-semibold">Pulau Sumatera</h1>
                <p class="text-base font-normal my-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo
                    quisquam
                    vero esse, eaque veritatis dolorem.</p>
                <form class="flex items-center my-10">
                    ...
                    <div class="relative w-full">
                        <input type="text" id="voice-search"
                            ...
                            placeholder="Search Provinces" required>
                    ...
                    <button type="submit"
                        class="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-teal-700 rounded-lg border border-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sumatera_aceh.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sumatera_utara.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sumatera_selatan.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sumatera_barat.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sumatera_bengkulu.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sumatera_Riau.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg"
                                src="./img/assets/provinsi/sumatera_kepulauan_Riau.png" alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sumatera_jambi.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sumatera_bangka.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sumatera_lampung.png"
                                alt=""></a>
                    </div>
                </div>
            </div>
