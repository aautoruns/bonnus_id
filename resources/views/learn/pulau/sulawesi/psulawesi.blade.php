    ...
    <section class="pt-20">
        ...
        <section id=portfolio class="pt-32 pb-32">
            <div class="container capitalize">
                <h1 class="text-4xl font-semibold">Pulau Sulawesi</h1>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sulawesi_utara.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sulawesi_tengah.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sulawesi_barat.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sulawesi_selatan.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/sulawesi_tenggara.png"
                                alt=""></a>
                    </div>
                    <div>
                        <a href="#">
                            <img class="h-auto max-w-full rounded-lg" src="./img/assets/provinsi/gorontalo.png"
                                alt=""></a>
                    </div>
                </div>
            </div>
